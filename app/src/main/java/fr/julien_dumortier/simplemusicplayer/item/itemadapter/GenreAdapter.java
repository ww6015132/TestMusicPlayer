...
public class GenreAdapter extends ItemAdapter {
	private Context mContext;
	private Typeface mFont;
	public GenreAdapter(final Context c, List<Item> genre, final IOnPictureReady listener) {
	...
	public View getView(int position, View view, ViewGroup parent) {
		...
		((ImageView)view.findViewById(R.id.img)).setImageDrawable(((Genre)mItems.get(position)).getPicture());
		((TextView)view.findViewById(R.id.txt)).setText(((Genre)mItems.get(position)).getGenreName());
